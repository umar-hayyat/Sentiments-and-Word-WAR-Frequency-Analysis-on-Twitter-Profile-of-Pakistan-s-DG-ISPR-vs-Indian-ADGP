...
edu_count = data.Tweets[data.Tweets.str.contains('war', flags=re.IGNORECASE)].count() 
print(f"DGISPR has tweeted about WAR {edu_count} times.")
print("--------------------------------")
print()
data.Tweets[data.Tweets.str.contains('war', flags=re.IGNORECASE)]
